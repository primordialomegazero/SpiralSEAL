...
execute_process(
  COMMAND "/usr/bin/git" show-ref "da607da739fa6047df13e66a2af6b8bec7c2a498"
  WORKING_DIRECTORY "/data/SpiralSEAL-build/build/thirdparty/zlib-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "da607da739fa6047df13e66a2af6b8bec7c2a498")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("da607da739fa6047df13e66a2af6b8bec7c2a498" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/da607da739fa6047df13e66a2af6b8bec7c2a498")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/data/SpiralSEAL-build/build/thirdparty/zlib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/data/SpiralSEAL-build/build/thirdparty/zlib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
