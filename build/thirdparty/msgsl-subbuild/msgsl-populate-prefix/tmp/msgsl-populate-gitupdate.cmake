...
execute_process(
  COMMAND "/usr/bin/git" show-ref "249146590e322123cd0b378b1f364d6069717687"
  WORKING_DIRECTORY "/data/SpiralSEAL-build/build/thirdparty/msgsl-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "249146590e322123cd0b378b1f364d6069717687")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("249146590e322123cd0b378b1f364d6069717687" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/249146590e322123cd0b378b1f364d6069717687")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/data/SpiralSEAL-build/build/thirdparty/msgsl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/data/SpiralSEAL-build/build/thirdparty/msgsl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
